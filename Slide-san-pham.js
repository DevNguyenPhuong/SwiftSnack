// Bài 1
const bai1_imgPosition = document.querySelectorAll(".bai1_slider-container img");
const bai1_imgContainer = document.querySelector(".bai1_slider-container");
let bai1_imgNumber = bai1_imgPosition.length;
let bai1_index = 0;
document.getElementById("image-position").innerHTML = "Ảnh " + String(parseInt(bai1_index + 1)) + "/" + bai1_imgNumber;
